...
ALTER TABLE MEMBER_MESSAGE ADD CONSTRAINTS MESSAGE_CHATTING_FK FOREIGN KEY(CHAT_ID) REFERENCES CHATTING(CHAT_ID);
ALTER TABLE MEMBER_MESSAGE ADD (CHAT_ID VARCHAR(30) NOT NULL);
ALTER TABLE MEMBER_MESSAGE ADD CONSTRAINTS MESSAGE_PK PRIMARY KEY(CHAT_ID, MSG_CHAT_ID);
-----------------------------------------------------------------------------------------------------------
...
ALTER TABLE ADMIN_MESSAGE ADD CONSTRAINTS ADMIN_MESSAGE_FK FOREIGN KEY(CHAT_ID) REFERENCES ADMIN_CHATTING(CHAT_ID);
ALTER TABLE ADMIN_MESSAGE ADD (CHAT_ID VARCHAR(30) NOT NULL);
ALTER TABLE ADMIN_MESSAGE ADD CONSTRAINTS ADMIN_MESSAGE_PK PRIMARY KEY(CHAT_ID, MSG_CHAT_ID);
ALTER TABLE ADMIN_MESSAGE ADD (CHAT_ID VARCHAR2(30) NOT NULL);
-----------------------------------------------------------------------------------------------------------
CREATE TABLE MEMBER_CHATTING(
...
ALTER TABLE MEMBER_CHATTING ADD CONSTRAINTS CHATTING_PK PRIMARY KEY(CHAT_ID);
ALTER TABLE MEMBER_CHATTING ADD CONSTRAINTS CHATTING_MEMBER_MEMBER_FK FOREIGN KEY(CHATTER1) REFERENCES MEMBERS(MEMBER_ID);
ALTER TABLE MEMBER_CHATTING ADD CONSTRAINTS CHATTING_ADMIN_MEMBER_FK FOREIGN KEY(CHATTER2) REFERENCES MEMBERS(MEMBER_ID);

-----------------------------------------------------------------------------------------------------------
CREATE TABLE ADMIN_CHATTING(
	CHAT_ID VARCHAR2(30) NOT NULL,
	CHATTER1 VARCHAR2(30) NOT NULL,
	CHATTER2 VARCHAR2(30) NOT NULL,
	DELFLAG CHAR(1) DEFAULT 'N'
...
ALTER TABLE ADMIN_CHATTING ADD CONSTRAINTS ADMIN_CHAT_PK PRIMARY KEY(CHAT_ID);
ALTER TABLE ADMIN_CHATTING ADD CONSTRAINTS ADMIN_CHAT_STADIUM_FK FOREIGN KEY(CHATTER1) REFERENCES STADIUM_ADMIN(ADMIN_ID);
ALTER TABLE ADMIN_CHATTING ADD CONSTRAINTS ADMIN_CHAT_STADIUM2_FK FOREIGN KEY(CHATTER2) REFERENCES MEMBERS(MEMBER_ID);
...
ALTER TABLE STADIUM ADD CONSTRAINTS STADIUM_ADMIN_FK FOREIGN KEY(ADMIN_ID) REFERENCES STADIUM_ADMIN(ADMIN_ID);
ALTER TABLE STADIUM MODIFY (STADIUM_NAME VARCHAR2(200));
-----------------------------------------------------------------------------------------------------------
...
ALTER TABLE BOARD ADD CONSTRAINTS BOARD_CATEGORY_FK FOREIGN KEY(CATEGORY_CODE) REFERENCES CATEGORY(CATEGORY_CODE);
...
ALTER TABLE TEAM DROP COLUMN MANNER;
-----------------------------------------------------------------------------------------------------------
